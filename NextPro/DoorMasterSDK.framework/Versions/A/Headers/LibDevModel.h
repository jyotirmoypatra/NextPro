 ...
 * 说明：
 * @param devModel  ：         操作的设备对象
 * @param WiFiName  ：         wifi名称（长度不超过32）
 * @param WiFiPwd   ：         wifi密码（长度不超过32）
 * @Param callBack  ：         操作成功的回调
 */
+(int)configHostWifi:(LibDevModel *)devModel WiFiName:(NSString *)WiFiName WiFiPwd:(NSString *)WiFiPwd andCallBack:(BlockOnControlOver)callBack;
 ...
 * @Param callBack  ：         操作成功的回调
 */
+(int)getHostNetworkInfo:(LibDevModel *)devModel andCallBack:(BlockOnControlOver)callBack;
 ...
 * 说明：
 * @param devModel  ：         操作的设备对象
 * @param commType  ：         通讯类型 0:MQTT 1:HTTP 2:TCP
 * @Param callBack  ：         操作成功的回调
 */
 ...
 * @Param callBack  ：         操作成功的回调
 */
+(int)getNormallyOpenEnable:(LibDevModel *)devModel andCallBack:(BlockOnControlOver)callBack;
